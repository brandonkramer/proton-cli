...
### Fixed
- Multi-product sign-in shares one session across Contacts/Settings/Mail (same `mail-api` host), gaps between products, and retries on API 2028 “too many recent logins”
