 ...
 *   PROTONCONTACTS_JSON=1  PROTONCONTACTS_AGENT=1  CI=true
 */
...
export function isAgentEnv(): boolean {
  return envTruthy("PROTONCONTACTS_AGENT") || envTruthy("CI");
}
...
/** Alias for TUI helpers (matches authenticator naming). */
