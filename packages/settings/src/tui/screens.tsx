...
export async function showHome(): Promise<TuiIntent> {
  return renderPrompt<TuiIntent>(({ resolve }) => {
    function Home(): ReactNode {
      ...
      const options = [
        { label: "Account settings", value: "get" },
        { label: "Mail settings", value: "mail" },
        { label: "List writable keys", value: "list-keys" },
        { label: "Update setting", value: "set" },
      ...
      return (
        <Box flexDirection="column">
          <Brand subtitle="Settings · ↑↓ enter · Esc/q back" />
          ...
          <Footer text="Sign in from the proton menu · Esc/q back · CLI: `proton settings …`" />
        </Box>
      );
    }
