/**
 * Agent / scripting mode: JSON output and non-interactive confirmations.
 *
 * Enable via --json, -y/--yes, or env:
 *   PROTON_DRIVE_JSON=1  PROTON_DRIVE_AGENT=1  PROTON_AGENT=1  CI=true
 */
...
/** Alias for TUI helpers (matches contacts/calendar naming). */
